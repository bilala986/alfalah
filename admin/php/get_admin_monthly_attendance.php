<?php
// admin/php/get_admin_monthly_attendance.php
...
try {
    ...
    error_log("Database error in get_admin_monthly_attendance.php: " . $e->getMessage());
    echo json_encode([
        'success' => false,
        'message' => 'Database error'
    ]);
} catch (Exception $e) {
    error_log("Error in get_admin_monthly_attendance.php: " . $e->getMessage());
    echo json_encode([
        'success' => false,
