<?php
// admin/php/get_attendance_admin.php
...
try {
    ...
    error_log("Database error in get_attendance_admin.php: " . $e->getMessage());
    echo json_encode([
        'success' => false,
        'message' => 'Database error'
    ]);
} catch (Exception $e) {
    error_log("Error in get_attendance_admin.php: " . $e->getMessage());
    echo json_encode([
        'success' => false,
