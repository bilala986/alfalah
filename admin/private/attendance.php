...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <a href="classes.php?bid=<?= $browser_instance_id ?>"><i class="bi bi-mortarboard"></i> Classes</a>
        ...
        <a href="parent-accounts.php?bid=<?= $browser_instance_id ?>"><i class="bi bi-person-heart"></i> Parents</a>
    ...
    <div class="content" id="content">
        ...
        <!-- Page Title -->
        <h2 class="dashboard-title mb-3">Attendance Management (Admin View)</h2>

        <!-- Admin Notice -->
        <div class="alert alert-info alert-dismissible fade show" role="alert">
            <i class="bi bi-info-circle me-2"></i>
            <strong>Admin Mode:</strong> You can view and manage attendance for any class. Teacher information is displayed for reference.
    ...
    <script>
        ...
        const adminId = <?= $_SESSION['admin_id'] ?? 0 ?>;
    </script>
